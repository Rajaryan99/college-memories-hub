      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-8">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-indigo-700 hover:text-purple-500 transition-colors duration-200 font-medium"
              >
                {item.name}
              </a>
            ))}
          ...
          <button
            ...
            className="md:hidden p-2 rounded-md text-indigo-700 hover:text-purple-500 hover:bg-indigo-50 transition-colors"
          >
          ...
          <div className="md:hidden py-4 border-t border-indigo-100">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="block py-2 text-indigo-700 hover:text-purple-500 transition-colors duration-200"
